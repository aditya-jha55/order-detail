                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                          ...
                          <p className="labelText">Lorem Ipsum is simply dummy text of the printing industry... 
                            <a href="">View More</a>
                          </p>
                        </Grid>
                      </Grid>
